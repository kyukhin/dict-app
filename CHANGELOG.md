...
### Added
- [#5] Reading Mode: a cup-and-saucer toggle in the Search and Definition toolbars keeps the screen awake. Per session; turns off when the app goes to background.
